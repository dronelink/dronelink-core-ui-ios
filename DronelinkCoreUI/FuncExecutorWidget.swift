...
public class FuncExecutorWidget: DelegateWidget, ExecutorWidget {
    ...
    public static var droneMarkAutoAlignment: ((_ input: Kernel.FuncInput, _ complete: @escaping (_ cancelled: Bool) -> ()) -> ())?
    ...
    @objc func onDroneMarkAuto(sender: UILongPressGestureRecognizer) {
        ...
        FuncExecutorWidget.droneMarkAutoAlignment?(input) { cancelled in
            if !cancelled {
