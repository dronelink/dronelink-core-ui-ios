...
open class DelegateWidget: Widget, DronelinkDelegate, DroneSessionManagerDelegate, DroneSessionDelegate, MissionExecutorDelegate, ModeExecutorDelegate, FuncExecutorDelegate {
    ...
    open func missionEngageDisallowedReasons(executor: MissionExecutor) -> [Kernel.Message]? { return nil }
    
    open func modeEngageDisallowedReasons(executor: ModeExecutor) -> [Kernel.Message]? { return nil }
    
    open func onCameraChanged(session: DroneSession, channel: UInt) {}
}
