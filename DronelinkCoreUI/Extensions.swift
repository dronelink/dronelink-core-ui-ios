...
extension String {
    ...
    var localized: String {
        let value = self.localizeForLibrary(libraryBundle: DronelinkUI.bundle, mainBundle: Bundle.main)
        return value
    }
...
extension UIColor {
    ...
    convenience init?(hex: String?, defaultAlpha: CGFloat = 0.5) {
        let r, g, b, a: CGFloat
        ...
        if hex.hasPrefix("#") ?? false {
            ...
            if hexColor.count == 6 {
                ...
                if scanner.scanHexInt64(&hexNumber) {
                    ...
                    self.init(red: r, green: g, blue: b, alpha: defaultAlpha)
                    return
                }
            }
