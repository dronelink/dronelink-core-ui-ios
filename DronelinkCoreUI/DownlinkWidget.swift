...
public class DownlinkWidget: UpdatableWidget {
    ...
    public override func viewDidLoad() {
        ...
        iconImageView = UIImageView(image: DronelinkUI.loadImage(named: "downLinkIcon")?.withRenderingMode(.alwaysTemplate))
